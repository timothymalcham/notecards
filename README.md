...
- Create two apps on Fly, one for staging and one for production:
  ...
  ```sh
  fly create notecards-c5b4
  fly create notecards-c5b4-staging
  ```
...
- Add a `SESSION_SECRET` to your fly app secrets, to do this you can run the following commands:
  ...
  ```sh
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app notecards-c5b4
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app notecards-c5b4-staging
  ```
...
- Create a database for both your staging and production environments. Run the following:
  ...
  ```sh
  fly postgres create --name notecards-c5b4-db
  fly postgres attach --postgres-app notecards-c5b4-db --app notecards-c5b4

  fly postgres create --name notecards-c5b4-staging-db
  fly postgres attach --postgres-app notecards-c5b4-staging-db --app notecards-c5b4-staging
  ```
